...
def main():
    ...
    base_path="word2vecf"
    text_features=[      
    [base_path+"/milestone_seq.256d",'milestone_seq',256,True],
    # [base_path+"/CREATED_BY_seq.32d",'CREATED_BY_seq',32,True],
    [base_path+"/UPDATED_BY_seq.256d",'UPDATED_BY_seq',256,True]
    ]
    base_path1="middle"

    #读取训练数据
    train_df=pd.read_pickle(os.path.join(base_path1,'train_all.pkl'))
    test_df=pd.read_pickle(os.path.join(base_path1,'test_all.pkl'))
